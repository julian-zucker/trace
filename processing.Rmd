...
undergradEvals <- csEvals %>% mutate(AvgTime = avgTime(.)) %>%
  filter(Number < 5000)
...
Summer classes are harder, but they don't seem that much harder, considering you'd only be taking two.
